...
<form action="{{route('admin_alerts')}}" method="post" id="admin-panel">
    ...
    <div class="form-group">
        ...
        <input name="title" type="title" class="form-control" id="title" placeholder="EzProxy maintenance"
    ...
    <div class="form-group">
        ...
        <input name="custom_alert" type="text" class="form-control" id="custom_alert" placeholder="EzProxy will not available..."
    ...
    <div class="form-group">
        ...
        <p class="text-muted">Choose wether this alert should be publicly visible or not.</p>
